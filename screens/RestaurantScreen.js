      ...
      <ScrollView>
        ...
        >
          <View className='px-5'>
            ...
            <Image source={require('../assets/images/fullStar.jpeg')}
                      className='h-4 w-4'/>
                  <Text className='text-xs'>
                      <Text className='text-green-700'>{item.stars}</Text>
                      <Text className='text-gray-700'>
                          ({item.reviews}k review) • <Text className='font-semibold'>{item?.type?.name}</Text>
                      </Text>
                  </Text>
              </View>
              ...
              <Text className='text-grat-500 mt-2'>{item.description}</Text> 
          </View>
        </View>
